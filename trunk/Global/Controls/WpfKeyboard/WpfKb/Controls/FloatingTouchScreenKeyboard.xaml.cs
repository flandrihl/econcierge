...
namespace WpfKb.Controls
{
    ///<summary>
    ///</summary>
    public partial class FloatingTouchScreenKeyboard : IMTouchControl
    {
        ...
        public bool IsKeyboardShown
        {
            ...
            set { SetValue(IsKeyboardShownProperty, value); }
...
*/
        ...
        void DragHandle_PreviewTouchUp(object sender, RoutedEventArgs e)
        {
            DragHandle.ReleaseMouseCapture();
            IsDragging = false;
            IsAllowedToFade = _isAllowedToFadeValueBeforeDrag;
