...
namespace TouchFramework.ControlHandlers
{
    ...
    /// </summary>
    public class BrowserHandler : ElementHandler
    {
        ...
        public override void Slide(float x, float y)
        {
            ...
            var c = a.newBrowser;
            //Cjc.ChromiumBrowser.WebBrowser c = this.Source as Cjc.ChromiumBrowser.WebBrowser;
            if (c == null) return;
