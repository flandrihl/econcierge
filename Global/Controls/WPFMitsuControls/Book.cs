...
{
    public partial class Book : ItemsControl, IMTouchControl
    {
        ...
        public void SetSelectedPages()
        {
            ...
            Canvas.SetZIndex((bp0 as BookPage), 1);
            Canvas.SetZIndex((bp1 as BookPage), 0);
            //if(((bp0.Content as Grid).Children[0] as ContentPresenter).Content==null)
            //    Canvas.SetZIndex((bp0 as BookPage), -1000);
            //if (((bp1.Content as Grid).Children[0] as ContentPresenter).Content == null)
            //    Canvas.SetZIndex((bp1 as BookPage), -1000);
        }
