...
namespace WpfKb.Controls
{
    ...
    public class OnScreenKeyboard : Grid
    {
        ...
        private static ObservableCollection<OnScreenKey> GetMainKeys()
        {
        ...
        private static ObservableCollection<OnScreenKey> GetArabicKeys()
        {
            return new ObservableCollection<OnScreenKey>
                       {
                           ...
                           new OnScreenKey { GridRow = 4, GridColumn = 1, Key =  new VirtualKey(VirtualKeyCode.SPACE, " "), GridWidth = new GridLength(5, GridUnitType.Star)},
                           new OnScreenKey { GridRow = 4, GridColumn = 0, Key = new VirtualKey(VirtualKeyCode.DELETE, "Del") },
                           new OnScreenKey { GridRow = 4, GridColumn = 2, Key = new VirtualKey(VirtualKeyCode.RETURN, "Done") },
                       };
        }

        private static ObservableCollection<OnScreenKey> GetEnglishKeys()
        {
            return new ObservableCollection<OnScreenKey>
                       {
