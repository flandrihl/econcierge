...
namespace TouchControls.ControlHandlers
{
    ...
    /// </summary>
    public class LocationRadioButtonHandler : ElementHandler
    {
        public override void Tap(PointF global, PointF relative)
        {
            var a = Source as LocationRadio;
        ...
        {
            var radio = Source as LocationRadio;
            var scrollViewer = radio.ScrollViewer;
